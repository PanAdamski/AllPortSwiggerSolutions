...
if __name__ == "__main__":
    ...
    print("sometimes the image reading library works poorly and doesn't understand this captcha")
    captcha_image_data = base64.b64decode(captcha_image_base64)
    captcha_image = Image.open(BytesIO(captcha_image_data))

    # Tutaj usuwamy captcha_image.show() i odczytujemy tekst z obrazu
    ...
    message = f'{{"message":"Tell me about the reviews for the product with id 1"}}'
